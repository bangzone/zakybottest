...
const starts = async (devil = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('DEVIL GANTENG', {
		font: 'Standard',
	...
	console.log(color('[SOURCE CODE INI DIJAGA DAN DI LINDUNGI OLEH DEVIL]\n\n', 'orange'), color('\n======TERIMKASIH BANYAK KEPADA======\n•MHANKBARBAR\n•NINO\n•IKYADS\n•DEVIL\n•SEMUA PATNER SAYA\n•DZBOTZ\n•PENYEDIA APIKEY\n•DHANI BOTZ\n•MY TEAM\n•ZAK BOTZ\n•AKIRA\n•FAUZANBOTZ\n•VIZZBOTZ\n•RAFATABOTZ\n•SEMUA SUBSCRIBER', 'yellow'))
	console.log(color('\n\nKALO MAU REUP TAG😑\nKALAU ADA YG MINTA SURUH CEK YT ©devil\nYOUTUBE DEVILBOTZ', 'pink'))
	devil.browserDescription = ["DEVIL BOTZ", "Chrome", "3.0.0"];
	...
	devil.on('connecting', () => {
		console.log(color('[ DEVILBOTZ ]', 'orange'), color('PROSES PENYAMBUNGAN'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	devil.on('open', () => {
		console.log(color('[ DEVILBOTZ ]', 'orange'), color('BOT SUDAH AKTIF SELAMAT MENGGUNAKAN:)'));
	})
